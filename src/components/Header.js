...
function Header() {
  ...
  return (
    <nav id="header" className={`fixed w-full z-10 top-0 ${scroll ? "bg-white shadow" : ""}`}>
      <div
        id="progress"
      ...
      <div className="w-full md:max-w-4xl mx-auto flex flex-wrap items-center justify-between mt-0 py-3">
        ...
        <div
          className={`w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 ${ scroll ? "bg-white": "bg-gray-100"} md:bg-transparent z-20`}
          id="nav-content"
        >
